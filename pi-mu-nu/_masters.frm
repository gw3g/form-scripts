...
*  id I(1,1,0,1,1,m?,1) = I(1,1,0,1,1,m,0)*k(0)/2;
  id I(1,1,-1,1,1,0,0) = I(1,1,0,1,0,0,0) + I(1,1,0,0,1,0,0) 
                       - k.k*I(1,1,0,1,1,0,0)/2;

*  symmetrize I (1,4,6) (2,5,7);
  .sort

  id I(a?,b?,c?,a?,b?,m?,n?) = ( I(a,b,c,a,b,m,n) + I(b,a,c,b,a,n,m) )/2;
...
*  id I(0,b?,c?,d?,e?,m?,n?) =  I(b,0,c,e,d,n,m);
  ...
  id I(0,b?,c?,d?,e?,0,0) = I(d,e,c,0,b,0,0);
  id I(0,b?,c?,d?,e?,0,1) = I(d,e,c,0,b,0,0)*k(0) - I(d,e,c,0,b,0,1);
  id I(0,b?,c?,d?,e?,1,0) = I(d,e,c,0,b,0,0)*k(0) - I(d,e,c,0,b,1,0);
  id I(0,b?,c?,d?,e?,1,1) = I(d,e,c,0,b,0,0)*k(0)^2 
                          - I(d,e,c,0,b,0,1)*k(0) 
                          - I(d,e,c,0,b,1,0)*k(0) 
                          + I(d,e,c,0,b,1,1);
  id I(0,b?,c?,d?,e?,0,2) = I(d,e,c,0,b,0,0)*k(0)^2 
                          - I(d,e,c,0,b,0,1)*2*k(0)
                          + I(d,e,c,0,b,0,2);
  id I(0,b?,c?,d?,e?,2,0) = I(d,e,c,0,b,0,0)*k(0)^2 
                          - I(d,e,c,0,b,1,0)*2*k(0)
                          + I(d,e,c,0,b,2,0);
  .sort
...
*  id I(0,0,2,1,0,0,0)  = I(0,1,2,0,0,0,0) ;
  ...
  id I(0,2,1,0,1,0,0)  = I(0,1,1,0,2,0,0) ;
  id I(a?,b?,c?,a?,b?,m?,n?) = ( I(a,b,c,a,b,m,n) + I(b,a,c,b,a,n,m) )/2;
  id I(0,0,c?,0,e?,0,0) = I(e,0,c,0,0,0,0);
  id I(0,0,c?,d?,0,0,0) = I(d,0,c,0,0,0,0);
  id I(0,b?,c?,0,0,0,0) = I(b,0,c,0,0,0,0);
*  symmetrize I (1,4,6) (2,5,7);
  .sort
  ...
  id I(2,0,1,1,0,1,0)  = I(1,0,1,2,0,0,0)*k(0) 
                       - I(1,0,1,2,0,1,0);
  id I(2,0,1,1,0,2,0)  = I(1,0,1,2,0,0,0)*k(0)^2
                       - 2*I(1,0,1,2,0,1,0)*k(0) 
                       + I(1,0,1,2,0,2,0);
  id I(1,0,2,1,0,n?,1) = I(1,0,2,1,0,n,0)*k(0) 
                       - I(1,0,2,1,0,n+1,0);
  .sort
